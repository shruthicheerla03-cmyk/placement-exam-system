/**
 * Firestore Questions Seeder Script
 * Deletes all existing questions and seeds with fresh placement exam data
 * 
...
async function deleteAllQuestions() {
  console.log('🗑️  Starting deletion of existing questions...');
  ...
  try {
    ...
    console.log(`✅ Deleted ${snapshot.docs.length} existing questions`);
  } catch (error) {
...
async function seedQuestions() {
  ...
  try {
    ...
    const summary = {
      aptitude: {
        easy: questionsData.filter(q => q.round === 'round1' && q.difficulty === 'Easy').length,
        medium: questionsData.filter(q => q.round === 'round1' && q.difficulty === 'Medium').length,
        hard: questionsData.filter(q => q.round === 'round1' && q.difficulty === 'Hard').length
      },
      os: {
        easy: questionsData.filter(q => q.subject === 'os' && q.difficulty === 'Easy').length,
        medium: questionsData.filter(q => q.subject === 'os' && q.difficulty === 'Medium').length,
        hard: questionsData.filter(q => q.subject === 'os' && q.difficulty === 'Hard').length
      },
      cn: {
        easy: questionsData.filter(q => q.subject === 'cn' && q.difficulty === 'Easy').length,
        medium: questionsData.filter(q => q.subject === 'cn' && q.difficulty === 'Medium').length,
        hard: questionsData.filter(q => q.subject === 'cn' && q.difficulty === 'Hard').length
      },
      coa: {
        easy: questionsData.filter(q => q.subject === 'coa' && q.difficulty === 'Easy').length,
        medium: questionsData.filter(q => q.subject === 'coa' && q.difficulty === 'Medium').length,
        hard: questionsData.filter(q => q.subject === 'coa' && q.difficulty === 'Hard').length
      },
      dsa: {
        easy: questionsData.filter(q => q.round === 'round3' && q.difficulty === 'Easy').length,
        medium: questionsData.filter(q => q.round === 'round3' && q.difficulty === 'Medium').length,
        hard: questionsData.filter(q => q.round === 'round3' && q.difficulty === 'Hard').length
      }
    };
    
    console.log('\n📊 SEEDING SUMMARY:');
    console.log('═══════════════════════════════════════');
    console.log('Round 1 - Aptitude:');
    console.log(`  Easy: ${summary.aptitude.easy} | Medium: ${summary.aptitude.medium} | Hard: ${summary.aptitude.hard}`);
    console.log('\nRound 2 - Core Subjects:');
    console.log(`  OS   -> Easy: ${summary.os.easy} | Medium: ${summary.os.medium} | Hard: ${summary.os.hard}`);
    console.log(`  CN   -> Easy: ${summary.cn.easy} | Medium: ${summary.cn.medium} | Hard: ${summary.cn.hard}`);
    console.log(`  COA  -> Easy: ${summary.coa.easy} | Medium: ${summary.coa.medium} | Hard: ${summary.coa.hard}`);
    console.log('\nRound 3 - DSA:');
    console.log(`  Easy: ${summary.dsa.easy} | Medium: ${summary.dsa.medium} | Hard: ${summary.dsa.hard}`);
    console.log('═══════════════════════════════════════');
    console.log(`\n✅ TOTAL QUESTIONS SEEDED: ${questionsData.length}`);
...
async function main() {
  console.log('🚀 Firebase Questions Seeder');
  console.log('═══════════════════════════════════════\n');
